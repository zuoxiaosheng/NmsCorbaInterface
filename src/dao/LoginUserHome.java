...
/**
 * Home object for domain model class LoginUser.
 * @see dao.LoginUser
 * @author Hibernate Tools
 */
public class LoginUserHome {

	private static final Log log = LogFactory.getLog(LoginUserHome.class);
	...
	public void persist(LoginUser transientInstance) {
		log.debug("persisting LoginUser instance");
		try {
	...
	public LoginUser merge(LoginUser detachedInstance) {
		...
		try {
			LoginUser result = (LoginUser) sessionFactory.getCurrentSession()
	...
	public LoginUser findById(java.lang.String id) {
		log.debug("getting LoginUser instance with id: " + id);
		try {
			LoginUser instance = (LoginUser) sessionFactory.getCurrentSession()
					.get("dao.LoginUser", id);
			if (instance == null) {
