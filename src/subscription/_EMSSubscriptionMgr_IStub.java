...
public class _EMSSubscriptionMgr_IStub
	...
	implements subscription.EMSSubscriptionMgr_I
{
	...
	public final static java.lang.Class _opsClass = subscription.EMSSubscriptionMgr_IOperations.class;
	...
	public boolean suspendSubscription(int subscriptionId) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "suspendSubscription", true);
	...
	public boolean resumeSubscription(int subscriptionId) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "resumeSubscription", true);
				_os.write_long(subscriptionId);
				_is = _invoke(_os);
				boolean _result = _is.read_boolean();
				return _result;
