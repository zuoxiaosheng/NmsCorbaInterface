...
public abstract class CallAndTopLevelConnectionsAndSNCsIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, callSNC.CallAndTopLevelConnectionsAndSNCsIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder _arg1= new callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				callSNC.CallAndTopLevelConnectionsAndSNCsList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
