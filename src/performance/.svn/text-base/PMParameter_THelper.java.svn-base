...
/**
 * Generated from IDL alias "PMParameter_T".
 *
...
public final class PMParameter_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(performance.PMParameter_THelper.id(), "PMParameter_T",org.omg.CORBA.ORB.init().create_string_tc(0));
		}
		return _type;
	}
