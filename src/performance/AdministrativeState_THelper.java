...
public final class AdministrativeState_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(performance.AdministrativeState_THelper.id(),"AdministrativeState_T",new String[]{"AS_Locked","AS_Unlocked"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final performance.AdministrativeState_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static performance.AdministrativeState_T extract (final org.omg.CORBA.Any any)
	{
