...
public final class PMLocationList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(performance.PMLocationList_THelper.id(), "PMLocationList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, performance.PMLocation_THelper.type()));
		}
		return _type;
	}
