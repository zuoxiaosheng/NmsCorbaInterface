...
public abstract class TransmissionSystemMgr_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, emsMgr.TransmissionSystemMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getTransmissionSytems", new java.lang.Integer(4));
		m_opsHash.put ( "setLocation", new java.lang.Integer(5));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 4: // getTransmissionSytems
			{
			try
			{
				globaldefs.NameAndStringValue_T[][] _arg0=globaldefs.NamingAttributesList_THelper.read(_input);
				emsMgr.TransmissionSystemList_THolder _arg1= new emsMgr.TransmissionSystemList_THolder();
				_out = handler.createReply();
				getTransmissionSytems(_arg0,_arg1);
				emsMgr.TransmissionSystemList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
