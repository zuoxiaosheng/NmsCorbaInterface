...
/**
 * Generated from IDL alias "StringList_T".
 *
...
public final class StringList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(globaldefs.StringList_THelper.id(), "StringList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().create_string_tc(0)));
		}
		return _type;
	}
	...
	{
		return "IDL:mtnm.tmforum.org/globaldefs/StringList_T:1.0";
	}
