...
public class _TransmissionSystemMgr_IStub
	...
	implements emsMgr.TransmissionSystemMgr_I
{
	...
	public final static java.lang.Class _opsClass = emsMgr.TransmissionSystemMgr_IOperations.class;
	...
	public void getTransmissionSytems(globaldefs.NameAndStringValue_T[][] nameList, emsMgr.TransmissionSystemList_THolder transmissionSystemList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "getTransmissionSytems", true);
				globaldefs.NamingAttributesList_THelper.write(_os,nameList);
				_is = _invoke(_os);
				transmissionSystemList.value = emsMgr.TransmissionSystemList_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
