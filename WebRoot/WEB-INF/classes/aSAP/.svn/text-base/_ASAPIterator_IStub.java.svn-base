...
public class _ASAPIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements aSAP.ASAPIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org/aSAP/ASAPIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = aSAP.ASAPIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			ASAPIterator_IOperations _localServant = (ASAPIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, aSAP.ASAPList_THolder aSAPList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,aSAPList);
			}
			finally
			{
				_servant_postinvoke(_so);
