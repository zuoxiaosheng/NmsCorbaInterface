...
/**
 * Generated from IDL struct "PMTPParamSelect_T".
 *
...
public final class PMTPParamSelect_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_struct_tc(performance.PMTPParamSelect_THelper.id(),"PMTPParamSelect_T",new org.omg.CORBA.StructMember[]{new org.omg.CORBA.StructMember("name", globaldefs.NamingAttributes_THelper.type(), null),new org.omg.CORBA.StructMember("layerRateList", transmissionParameters.LayerRateList_THelper.type(), null),new org.omg.CORBA.StructMember("pMLocationList", performance.PMLocationList_THelper.type(), null),new org.omg.CORBA.StructMember("granularityList", performance.GranularityList_THelper.type(), null),new org.omg.CORBA.StructMember("pmParameterList", performance.PMParameterList_THelper.type(), null)});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final performance.PMTPParamSelect_T s)
	{
		any.type(type());
	...
	public static performance.PMTPParamSelect_T read (final org.omg.CORBA.portable.InputStream in)
	{
		performance.PMTPParamSelect_T result = new performance.PMTPParamSelect_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final performance.PMTPParamSelect_T s)
	{
