...
public class _AlarmDataIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements alarmMgr.AlarmDataIterator_I
{
	...
	public final static java.lang.Class _opsClass = alarmMgr.AlarmDataIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			AlarmDataIterator_IOperations _localServant = (AlarmDataIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, alarmMgr.AlarmDataList_THolder alarmDataList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				alarmDataList.value = alarmMgr.AlarmDataList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,alarmDataList);
			}
			finally
			{
				_servant_postinvoke(_so);
