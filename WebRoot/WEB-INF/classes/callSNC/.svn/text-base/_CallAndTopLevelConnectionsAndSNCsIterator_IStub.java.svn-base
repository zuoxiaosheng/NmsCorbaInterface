...
public class _CallAndTopLevelConnectionsAndSNCsIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements callSNC.CallAndTopLevelConnectionsAndSNCsIterator_I
{
	...
	public final static java.lang.Class _opsClass = callSNC.CallAndTopLevelConnectionsAndSNCsIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			CallAndTopLevelConnectionsAndSNCsIterator_IOperations _localServant = (CallAndTopLevelConnectionsAndSNCsIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder callAndTopLevelConnectionsAndSNCsList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,callAndTopLevelConnectionsAndSNCsList);
			}
			finally
			{
				_servant_postinvoke(_so);
