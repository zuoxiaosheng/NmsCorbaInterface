...
public class _SubnetworkIterator_IStub
	...
	implements multiLayerSubnetwork.SubnetworkIterator_I
{
	...
	public final static java.lang.Class _opsClass = multiLayerSubnetwork.SubnetworkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, multiLayerSubnetwork.SubnetworkList_THolder subnetworkList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				subnetworkList.value = multiLayerSubnetwork.SubnetworkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
